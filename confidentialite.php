...
$titre=' politique de confidentialité '.$nomdusite;
$cheminaudio='/audio/sons_des_pages/CERS.mp3';
$stats_page = 'conf'; ?>
<!DOCTYPE html>
<html lang="fr">
...
<h2><?php print $nomdusite; ?> respecte votre vie privée</h2>
...
<p>Si vous désirez en savoir plus sur la sécurité de vos données, nos méthodes, votre anonymat, ou toute autre chose, vous pouvez nous contacter via le <a href="/contacter.php">formulaire de contact</a> avec le sujet "<i>demande sur la politique de confidentialité</i>".</p>
