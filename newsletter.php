...
<html>
	<head>
		<meta charset="utf-8">
		<title>Confirmation de l\'inscription à l\'actu '.$nomdusite.'</title>
	</head>
	<body>
		<div id="header">
		...
		<div id="content">
			<h2>Bonjour</h2>
			<p>Vous avez bien été abonné à l\'actu '.$nomdusite.'.</p>
			...
			$msgtext = "Confirmation d'inscription à l'actu $nomdusite (version texte) :
			Bonjour,
Vous avez bien été abonné à l'actu $nomdusite.
...
L'équipe $nomdusite";
			...
			$mail->Subject = 'Confirmation de l\'inscription à l\'actu '.$nomdusite;
			$mail->CharSet = 'UTF-8';
			$mail->IsHTML(TRUE);
			$mail->Body = $message;
...
if(isset($_GET['stop']))
	$log .= 'Vous avez bien été désinscrit de l\'actu '.$nomdusite.'. Un mail vous a été envoyé pour confirmer. Vous ne recevrez plus aucun mail de notre part.';
...
<p>Inscrivez-vous à l'actu <?php print $nomdusite; ?> pour connaître toutes les nouveautés et maintenir vos logiciels à jour! Vous pouvez choisir d'être notifié à chaque mise à jour d'un logiciel.<br>
Veuillez noter que le mail de l'actu <?php print $nomdusite; ?> est envoyé automatiquement, sans aucune intervention de la part de l'équipe, à 19:50.</p>
