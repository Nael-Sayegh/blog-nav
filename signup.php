    ...
    if ($log === '' || $log === '0')
    {
        ...
        else
        {
            ...
            if (isset($_POST['nl']) && $_POST['nl'] === 'on')
            {
                ...
                $SQL = <<<SQL
                    INSERT INTO nav.newsletter_mails (hash, mail, freq, freq_n, notif_site, notif_upd, notif_upd_n, lang, lastmail, lastmail_n) VALUES (:hash, :mail, 3, 3, true, true, true, :lang, :last, :lastn)
                    SQL;
                $req = $bdd->prepare($SQL);
