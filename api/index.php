...
<?php if (isset($_SERVER['HTTP_USER_AGENT']) && str_contains((string) $_SERVER['HTTP_USER_AGENT'], 'Trident'))
{
...
<p><?= tr($tr, 'intro_text') ?></p>

<h2><?= tr($tr, 'doc_title') ?></h2>

<h3><?= tr($tr, 'version_title') ?></h3>
<p><?= tr($tr, 'version_text', ['apiversion' => $api_version]) ?></p>
