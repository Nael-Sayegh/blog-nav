...
$tr = [
  ...
  'maintext' => <<<ENDSTR
      ...
      <h2>Notre équipe</h2>
      <p>Voici le détail des membres qui composent l'équipe de {{site}}</p>
      <ul>
      {{teamlist}}
      </ul>
      <ul>
      ...
      <p>Pour les 10 ans de {{site}} le 25 Mai 2025, un évènement a lieu sur <a href="A189">TeamTalk</a>. Une <a href="https://www.youtube.com/watch?v=fjy7Ou7Bt_E">chanson pour les 10 ans</a> est également créée pour l'occasion. Cet évènement rassemble des membres de la communauté présents ou non depuis le début, dans le but de se retrouver autour d'une table virtuelle pour discuter du projet, se raconter les anecdotes de chacun, parler de l'avenir du site, et lancer en direct la mise à jour des 10 ans ({{site}} 20.0).</p>
      ...
      <ul>
      <li><a href="/newsletter.php">S'inscrire à la lettre d'informations (envoi chaque soir à 19h50)</a></li>
      ...
      <td>Corentin</td>
      <td>Traduction française, code</td>
      </tr>
      <tr>
      <td>Sullivan+</td>
      <td>Android</td>
      <td>Corentin</td>
      <td>Traduction française</td>
      </tr>
      <tr>
