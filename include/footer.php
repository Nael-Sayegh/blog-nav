...
?>
<footer id="footer">
<p role="alert"><strong>Parce que l\'accessibilité est une cause du quotidien, luttons pour que les transports soit aussi accessibles à tous.<br>À Bordeaux, l\'accessibilité du réseau de transports doit être améliorée, pour défendre cette cause, Corentin, fondateur de {{site}} a lancé une pétition adressée à TBM et Bordeaux Métropole.<br>Pour soutenir cette action, <a href="https://www.change.org/p/tbm-pour-l-annonce-syst%C3%A9matique-de-la-destination-d-un-tram">signez et partagez la pétition</a>.<br>Merci pour votre soutien.</strong></p>
