...
Pour faire une réclamation, <a href="/contacter.php">contactez-nous</a>, sinon <a href="/">retournez à l\'accueil</a>.<br>
L\'Administration</p>';
else
echo '<p>Des autorisations que vous ne possédez pas sont requises pour accéder à la ressource demandée.<br>
Si vous pensez disposer des droits requis, <a href="/contacter.php">contactez-nous</a>, sinon <a href="/">retournez à l\'accueil</a>.<br>
L\'Administration</p>'; ?>
</body>
</html>