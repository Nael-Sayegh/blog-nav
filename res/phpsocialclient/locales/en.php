...
*/
$tr=array('PHP_LANG'=>'en_US.UTF8','HTTP_LANG'=>'en,en-US','PHP_TIME_HOUR'=>'%H:%M','PHP_TIME_DAY'=>'%a %e at %H:%M','PHP_TIME_MONTH'=>'%a %e %b at %H:%M','PHP_TIME_YEAR'=>'%a %e %b %Y at %H:%M','FB_TITLE'=>'{{title}} | Facebook','FB_SHARE'=>'Share','FB_FBLNK'=>'Comment or like','TW_TITLE'=>'{{title}} | Twitter','TW_LIKE'=>'Like','TW_LIKE_ARIA'=>'Like','TW_SHARE'=>'Share','TW_SHARE_ARIA'=>'Share','TW_TWLNK'=>'See on Twitter','TW_TWLNK_ARIA'=>'See on Twitter'); ?>
