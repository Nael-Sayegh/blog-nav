...
*/
$tr=array('PHP_LANG'=>'fr_FR.UTF8','HTTP_LANG'=>'fr,fr-FR','PHP_TIME_HOUR'=>'%H:%M','PHP_TIME_DAY'=>'%a %e à %H:%M','PHP_TIME_MONTH'=>'%a %e %b à %H:%M','PHP_TIME_YEAR'=>'%a %e %b %Y à %H:%M','FB_TITLE'=>'{{title}} | Facebook','FB_SHARE'=>'Partager','FB_FBLNK'=>'Commenter ou aimer','TW_TITLE'=>'{{title}} | Twitter','TW_LIKE'=>'J\'aime','TW_LIKE_ARIA'=>'J\'aime','TW_SHARE'=>'Partager le Tweet','TW_SHARE_ARIA'=>'Partager','TW_TWLNK'=>'Voir le statut','TW_TWLNK_ARIA'=>'Voir le statut'); ?>
