...
function mastodonShareButtonClick(e) {
	...
	const sharingText = "<?php echo addslashes(tr($tr0,'masto_share_title')); ?>" + href + "<?php echo addslashes(tr($tr0,'masto_share_desc')); ?>";
	...
	if (mastodonInstance.indexOf('/') === -1) {
		...
		alert("<?php echo addslashes(tr($tr0,'masto_share_instanceçerror')); ?>");
	}
}
